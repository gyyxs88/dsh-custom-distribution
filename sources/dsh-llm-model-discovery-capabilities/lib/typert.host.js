...
const _deepseek_ai_dsh_llm_llm_discoverModels_result$schema = z.array(z.object({
  ...
  'off': z.union([z.literal(null), z.string()]).optional(),
  'minimal': z.union([z.literal(null), z.string()]).optional(),
  'low': z.union([z.literal(null), z.string()]).optional(),
  'medium': z.union([z.literal(null), z.string()]).optional(),
  'high': z.union([z.literal(null), z.string()]).optional(),
  'xhigh': z.union([z.literal(null), z.string()]).optional(),
  'max': z.union([z.literal(null), z.string()]).optional(),
})]).optional(),
  'defaultReasoningEffort': z.union([z.literal("off"), z.literal("minimal"), z.literal("low"), z.literal("medium"), z.literal("high"), z.literal("xhigh"), z.literal("max")]).optional(),
}))
  ...
  invocations: [
    {
      ...
      sourceLocation: {"file":"packages/llm/llm/src/index.ts","line":641,"column":9},
    },
    {
