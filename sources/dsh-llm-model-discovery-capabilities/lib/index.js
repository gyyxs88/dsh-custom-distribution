		...
		*/
		async discoverModels(settingsNs, request, signal) {
			...
			for (const model of discovered) {
				...
				seen.add(model.id);
				const input = model.input === void 0 ? void 0 : [...new Set(model.input.filter((value) => value === "text" || value === "image"))];
				const rawReasoningEfforts = model.reasoningEfforts;
				const reasoningEfforts = rawReasoningEfforts === void 0 || rawReasoningEfforts === false ? rawReasoningEfforts : Object.fromEntries([
					"off",
					"minimal",
					"low",
					"medium",
					...
					const value = rawReasoningEfforts[level];
					return typeof value === "string" || value === null ? [[level, value]] : [];
				}));
				const defaultReasoningEffort = model.defaultReasoningEffort !== void 0 && typeof reasoningEfforts === "object" && model.defaultReasoningEffort in reasoningEfforts ? model.defaultReasoningEffort : void 0;
				models.push({
					id: model.id,
