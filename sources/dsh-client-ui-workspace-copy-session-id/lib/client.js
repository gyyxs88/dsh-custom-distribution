			...
			return (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.HoverCard, {
				anchor: (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						children: (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
							...
							onSelect: (id) => {
								...
								if (id === "copy-session-id") {
									...
									setCopyStatus(null);
									void (0, _deepseek_ai_dsh_client_ui_primitives.writeClipboard)(node.id).then((ok) => {
						...
						}), copyStatus !== null && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Toast, {
