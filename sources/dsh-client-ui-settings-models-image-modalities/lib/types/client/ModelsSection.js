...
import { DefaultModelEditor } from "./DefaultModelEditor.js";
...
function Loaded({ injected, renderSlot }) {
    ...
    return (_jsxs("div", { className: styles['section'], children: [_jsx("h2", { className: styles['title'], children: t('title') }), _jsx("p", { className: styles['intro'], children: t('intro') }), defaultModelNamespace === undefined
                ? null
                : (_jsx(DefaultModelEditor, { namespace: defaultModelNamespace, groups: state.groups, operations: operations, controller: controller, t: t, readOnly: !state.writable }, defaultModelNamespace.revision)), state.modelFailures.length === 0
                ? null
                : _jsx("p", { className: styles['notice'], children: t('modelCatalogPartial') }), !state.writable && state.status === 'ready' ? _jsx("p", { className: styles['notice'], children: t('readOnly') }) : null, savedIdentity === undefined
                ? null
